                ...
                <div className="pt-3">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input aria-label="Game 1 Score for School A" id="game1A" className="input"
                                       type="number"
                                       name="game1A" min={0} placeholder={"0"} required/></td>
                            <td><input aria-label="Game 1 Score for School B" id="game1B" className="input"
                                       type="number"
                                       name="game1B" min={0} placeholder={"0"} required/></td>
                        </tr>
                        <tr>
                            <td className="p-2">GAME 2</td>
                            <td><input aria-label="Game 2 Score for School A" id="game2A" className="input"
                                       type="number"
                                       name="game2A" min={0} placeholder={"0"} required/></td>
                            <td><input aria-label="Game 2 Score for School B" id="game2B" className="input"
                                       type="number"
                                       name="game2B" min={0} placeholder={"0"} required/></td>
                        </tr>
                        <tr>
                            <td className="p-2">GAME 3</td>
                            <td><input aria-label="Game 3 Score for School A" id="game3A" className="input"
                                       type="number"
                                       name="game3A" min={0} placeholder={"0"}/></td>
                            <td><input aria-label="Game 3 Score for School B" id="game3B" className="input"
                                       type="number"
                    ...
                    <form>
                        ...
                        <div className="is-flex is-flex-direction-row is-justify-content-space-between ">
                            ...
                            <div className="is-flex is-flex-direction-column">
                                ...
                                <div className="flex-horizontal">
                                    <input type="radio" id="round-robinChange" name="match-typeChange"
                                           value="round-robin"
                                           required/>
                                    <label htmlFor="round-robin">Round Robin</label>
                                </div>
                                <div className="is-flex is-flex-direction-row">
                                    <input type="radio" id="eliminationChange" name="match-typeChange"
                                           value="elimination"
                                           required/>
                                    <label htmlFor="elimination">Elimination</label>
                                </div>
